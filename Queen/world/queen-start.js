  ...
  const FOLDERS = [
    {
      ...
      programs: [
        ...
        { id: "os", label: "Queen Desktop", hint: "Taskbar shell", url: "/world/queen-desktop.html" },
    ...
    },
    {
      ...
      programs: [
        ...
        { id: "nexus", label: "Field Command", hint: "Operator deck", url: "http://127.0.0.1:9477/command" },
    ...
    },
    {
      ...
      programs: [
        { id: "hostess", label: "AI Training Hub", hint: "Every AI lane", url: "/world/queen-hostess7-hub.html" },
        { id: "hostess", label: "Hostess Brain", hint: "Super intelligence", url: "queen://hostess" },
        { id: "hostess", label: "Training Viewer", hint: "Connected models", url: "http://127.0.0.1:9488/" },
        { id: "eyeball", label: "Final_Eye", hint: "Vision NN", url: "queen://eyeball" },
        { id: "earball", label: "Final Ear", hint: "Audio NN", url: "/world/queen-final-ear-manager.html" },
