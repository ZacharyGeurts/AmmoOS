...
def _resolve_queen_scheme(url: str) -> str:
    ...
    mapping = {
        ...
        "amouranthrtx": "/api/amouranthrtx",
        "engine": "/api/amouranthrtx",
        "gameroom": "/world/?dock=gameroom",
        "game-room": "/world/?dock=gameroom",
        "chips": "/world/?dock=gameroom",
        "cinema": "/world/?dock=gameroom",
