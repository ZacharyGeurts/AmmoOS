...
def _library_formats() -> list[dict[str, Any]]:
    return [
        _norm_row(fid="h7b", label="H7B Book", family="library", extensions=[".h7"], magic="H7B\\x01",
                  mime="application/vnd.hostess7.h7b", compression="fld1+zlib", lossless=True, ironclad=True,
                  dewey="005.74", description="Hostess7 lossless book — zlib + FLD1 fly layer.", source="field_h7_book"),
