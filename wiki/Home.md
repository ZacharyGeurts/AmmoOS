...
**[→ GitHub: ZacharyGeurts/AmmoOS](https://github.com/ZacharyGeurts/AmmoOS)** · [Manual](https://zacharygeurts.github.io/AmmoOS/) · [Stack hub](https://zacharygeurts.github.io/ZacharyGeurts/stack.html) · [Release v2.0.0-beta4](https://github.com/ZacharyGeurts/AmmoOS/releases/tag/v2.0.0-beta4)

**AmmoOS 2.0.0-beta4 (WATCHGUARD)** — field OS on loopback `127.0.0.1`. Queen Browser shell, NEXUS C2, KILROY kernel, ZNetwork pipe. All stack components ship inside the AmmoOS tree.
...
Full guide → **[Installers](Installers)** · **[AmmoOS Beta 4](AmmoOS-Beta4)**
