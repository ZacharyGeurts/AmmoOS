...
Guide for **v10.4.0** release tarballs and in-tree scripts.
...
| File | Use |
|------|-----|
| `nexus-shield-10.4.0-source.tar.gz` | Full tree — **recommended** |
| `nexus-shield-10.4.0-installers.tar.gz` | Scripts only |
