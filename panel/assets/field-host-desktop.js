/**
 * Field Host Desktop — AmmoOS C2 wallpaper, program icons, taskbar, keyboard sovereignty.
 */
(function () {
  "use strict";
  ...
  async function refresh() {
    ...
    try {
      ...
      if (window.NexusFieldShell) {
        ...
        window.NexusFieldShell.renderDesktopIcons?.(state.data);
      }

      engageKeyboardSovereign();
      global.FieldOsKeybindings?.init?.();
    } catch (e) {
