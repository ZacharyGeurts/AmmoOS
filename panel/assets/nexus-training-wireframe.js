...
const canvas = document.getElementById("nexus-training-wireframe-canvas");
const hud = document.getElementById("nexus-training-wireframe-hud");
const detail = document.getElementById("nexus-training-node-detail");
