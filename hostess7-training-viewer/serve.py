...
def bundle_training_data(*, refresh: bool = False) -> dict[str, Any]:
    if refresh:
        ...
        _py_json("hostess7-training.py", ["panel"], timeout=45)
    ...
    bundle = {
        ...
        "master": _py_json("hostess7-master.py", ["status"], timeout=30),
        ...
        "field_array": _load(STATE / "hostess7-field-array.json", {}),
        "master_sim": _load(STATE / "hostess7-master-sim-panel.json", {}),
        ...
        "ledger_master_ops": _tail_jsonl(STATE / "hostess7-master-ops.jsonl", limit=12),
