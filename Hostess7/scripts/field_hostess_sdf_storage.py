...
SDF_LAYERS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "body": (
            ...
            "run verify-redata or ZAC7 verify for checksum truth. Imaging is dual-channel; lossless is law."
        ),
    },
    {
        "id": "vision_recall",
    ...
    },
    {
        "id": "field_drive_fold",
        "stage": 5,
        "title": "Field drive fold — sdfFoldBlock beside ZAC archive",
        "tags": ("fieldstorage", "zac", "fold", "wave", "persist", "brain"),
        "body": (
            "brain/sdf/ lives beside superintel corpora; zac-pack includes it in fieldstorage shards. "
            ...
            "TEAM drive sync: ./Hostess7.sh team-sync mirrors canonical Hostess7/cache/fieldstorage."
        ),
    },
    {
        "id": "primer_link",
...
def seed_doctrine() -> Path:
    ...
    brief_text = (
        ...
        "Verify: ./Hostess7.sh sdf-verify-redata · ZAC: NewLatest/Textbook/build-field-technology-zac.py\n"
