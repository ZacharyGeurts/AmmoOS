...
TOOL_ENTRIES: tuple[dict[str, object], ...] = (
    ...
    {"id": "readme", "category": "docs", "title": "README.md",
     ...
     "summary": "Quick start, seven agents, reach, zac, QA.",
    ...
    {"id": "fly_codec", "category": "storage", "title": "field_fly_codec.py",
     ...
     "summary": "FLD1 lossless fly compression for brain JSON — used by ZAC and H7.",
     "tags": ("fld1", "compression", "zac", "h7", "lossless")},
    ...
    {"id": "self_update", "category": "reach", "title": "Self-update pipeline",
     ...
     "summary": "reach scan → QA → zac-pack → git pull. apply needs HOSTESS7_EXEC=1.",
    ...
    # ZAC storage
    {"id": "zac", "category": "storage", "title": "field_zac.py",
     "path": "scripts/field_zac.py", "cmd": "./Hostess7.sh zac-pack",
     "summary": "Pack/restore/verify infinite brain shards for GitHub.",
     "tags": ("zac", "pack", "restore", "github")},
    ...
    {"id": "queen_redata_teach", "category": "queen", "title": "Queen redata teach",
     ...
     "summary": "Comfort brief + build tools for Queen brain deck (ZAC, Field Primer, verify).",
     "tags": ("queen", "redata", "teach", "comfort", "zac", "textbook")},
    ...
    {"id": "textbook_zac", "category": "queen", "title": "Field Technology ZAC monolith",
     "path": "NewLatest/Textbook/build-field-technology-zac.py",
     "cmd": "pythong NewLatest/Textbook/build-field-technology-zac.py",
     "summary": "22 chapters → ZAC7 monolith + SDF brain + PDF/Text/Web size comparison.",
     "tags": ("textbook", "zac", "field technology", "field primer")},
